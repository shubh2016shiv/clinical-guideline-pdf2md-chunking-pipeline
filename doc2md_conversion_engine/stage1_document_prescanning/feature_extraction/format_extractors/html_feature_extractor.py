"""
stage1_document_prescanning/feature_extraction/format_extractors/html_feature_extractor.py
==========================================================================================
Stage 1 · Step 2 of 3 — the reader for HTML files.
...
def build_html_feature_profile(
    *,
    ...
    return DocumentFeatureProfile(
        ...
        visuals=visual_evidence,
        visual_candidates=visual_candidates,
        format_support=get_engine_format_compatibility(FeatureDocumentType.HTML),
